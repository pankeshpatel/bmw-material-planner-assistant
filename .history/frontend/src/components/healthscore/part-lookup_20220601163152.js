...
export const PartLookUp = (props) => {
 ...
 // }
  ...
  useEffect(async () => {
    ...
    const healthScoreResponse3 = await healthScoreCall("7417886-07", date);
    const healthScoreResponse4 = await healthScoreCall("7417886-07", date);
    const healthScoreResponse5 = await healthScoreCall("7417886-07", date);
