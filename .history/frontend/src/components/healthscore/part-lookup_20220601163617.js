...
export const PartLookUp = (props) => {
 ...
 // }
  ...
  useEffect(async () => {
    ...
    const healthScoreResponse2 = "";
    const healthScoreResponse3 = "";
    const healthScoreResponse4 = '';
    const healthScoreResponse5 = "";

    if (is114){
      healthScoreResponse = await healthScoreCall("7430935-05", date);
      healthScoreResponse2 = await healthScoreCall("7417886-07", date);
      healthScoreResponse3 = await healthScoreCall("8091983-05", date);
      healthScoreResponse4 = await healthScoreCall("7420657-10", date);
      healthScoreResponse5 = await healthScoreCall("8071659-07", date);
    }
    else if (is177){
      healthScoreResponse = await healthScoreCall("7430935-05", date);
      healthScoreResponse2 = await healthScoreCall("7417886-07", date);
    ...
    sethealthResponse3(healthScoreResponse2);
    sethealthResponse4(healthScoreResponse2);
    sethealthResponse5(healthScoreResponse2);
