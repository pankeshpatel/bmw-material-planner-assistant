...
export const PartLookUp = (props) => {
 ...
 // }
  ...
  useEffect(async () => {
    ...
    const healthScoreResponse2 = await healthScoreCall(String(material_A2), date);
    const healthScoreResponse3 = await healthScoreCall(String(material_A3), date);
    const healthScoreResponse4 = await healthScoreCall(String(material_A4), date);
    const healthScoreResponse5 = await healthScoreCall(String(material_A5), date);
