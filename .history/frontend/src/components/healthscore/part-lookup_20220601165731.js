...
export const PartLookUp = (props) => {
 ...
 // }
  ...
  const hell = async() => {
    ...
    const healthScoreResponse = await healthScoreCall("8071659-07", date);
    const healthScoreResponse2 = await healthScoreCall("8071659-07", date);
    const healthScoreResponse3 = await healthScoreCall("8071659-07", date);
    const healthScoreResponse4 = await healthScoreCall("8071659-07", date);
