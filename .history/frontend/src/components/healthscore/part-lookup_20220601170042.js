 ...
 // }
  ...
  useEffect(async () => {
    ...
    if (is114){
      ...
      localStorage.setItem("MAT_2", "7430935-05");
      localStorage.setItem("MAT_3", "7430935-05");
      localStorage.setItem("MAT_4", "7430935-05");
      localStorage.setItem("MAT_5", "7430935-05");
    ...
    // const healthScoreResponse = await healthScoreCall(material_A1, date);
    ...
    let A1 = localStorage.getItem("MAT_1");
    let A2 = localStorage.getItem("MAT_2");
    let A3 = localStorage.getItem("MAT_3");
    let A4 = localStorage.getItem("MAT_4");
    let A5 = localStorage.getItem("MAT_5");



    const healthScoreResponse = await healthScoreCall(A1, date);
    const healthScoreResponse2 = await healthScoreCall(A2, date);
    const healthScoreResponse3 = await healthScoreCall(A3, date);
    const healthScoreResponse4 = await healthScoreCall(A4, date);
    const healthScoreResponse5 = await healthScoreCall(A5, date);
