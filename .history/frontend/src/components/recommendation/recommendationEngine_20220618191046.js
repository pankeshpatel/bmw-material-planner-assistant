    ...
    <Card {...props} className={classStyle.card}>
      ...
      <CardContent>
        ...
        <Box
          ...
          alignItems="flex-end"
        >
          <ButtonGroup disableElevation variant="text" sx={{ height: 60, width:"50%",fontSize:20, fontWeight:0, color:"#FFFFFF", backgroundColor:"#00cc00" }}>
            <Button variant="contained"  align="right"> One</Button>
            <Button>Two</Button>
          </ButtonGroup>
