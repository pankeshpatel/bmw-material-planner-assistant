    ...
    <Card {...props} className={classStyle.card}>
      ...
      <CardContent>
        ...
        <Box
          ...
          alignItems="flex-end"
        >
          <ButtonGroup disableElevation variant="text" width="30%" sx={{ height: 60,fontSize:20}}>
            <Button varient="contained">Reject</Button>
            <Button varient="contained">Agree</Button>
          </ButtonGroup>
