      ...
      <CardContent>
        ...
        >
          <ButtonGroup disableElevation variant="contained" sx={{ height: 60,fontSize:20, width:'20%'}}>
            <Button sx={{width:'50%', fontSize:20, fontWeight:0, color:"#FFFFFF", backgroundColor:"#00cc00" }}>Reject</Button>
            <Button sx={{width:'50%', fontSize:20, fontWeight:0, color:"#FFFFFF", backgroundColor:"#FF0000" }}>Agree</Button>
          </ButtonGroup>
