    ...
    <Card {...props} className={classStyle.card}>
      ...
      <CardContent>
        ...
        Our only rule about the list is that it has to be aimed at fun, not productivity. We don’t include work goals. We don’t include anything that might read as productive. The goal for summer is to lessen the pressure to be anything more than we are.
          ...
          <Typography>Ad sint scripta theophrastus sed. Vide mandamus ut nec, et mea vide magna nostro. Ea laboramus scriptorem duo, nonumy sanctus legimus no vim, sea ex quidam vivendo. Et ferri consulatu eam, docendi corpora intellegam no vim, ubique perpetua est in.
        ...
        <Box
          ...
          // alignItems="flex-end"
        >
          <ButtonGroup disableElevation variant="contained" sx={{ height: 60,fontSize:20, width:'20%',           display="flex",
          justifyContent="flex-end",
          alignItems="flex-end"}}>
